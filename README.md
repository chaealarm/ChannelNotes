...
Channel Notes는 Discord에서 영감을 받은 그룹·채널·카테고리 구조의 Windows 로컬 메모 애플리케이션입니다. Go와 Wails v3로 작성되며 별도 서버나 계정 없이 PC에 데이터를 저장합니다.
...
- [Wails v3 CLI](https://v3.wails.io/getting-started/installation/) 3.0.0-beta.16 이상
...
자동저장은 입력 후 약 1.2초, 최대 5초 주기, 그룹·채널·카테고리·메모 전환 및 종료 요청 시 수행됩니다. 여러 메인 창을 실행하면 한 그룹은 한 창에서만 선택할 수 있고, 서로 다른 그룹의 저장 내용은 병합되어 다른 창의 작업을 덮어쓰지 않습니다. 분리 편집기는 해당 메인 창이 보유한 그룹 세션에 종속됩니다.
